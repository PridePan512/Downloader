...
class YtDlpOptions {
    ...
    fun addOption(option: String, argument: String): YtDlpOptions {
    ...
    fun addOption(option: String, argument: Number): YtDlpOptions {
        if (!options.containsKey(option)) {
            val arguments: MutableList<String> = ArrayList()
    ...
    fun addOption(option: String): YtDlpOptions {
        if (!options.containsKey(option)) {
            val arguments: MutableList<String> = ArrayList()
            arguments.add("")
            options[option] = arguments
